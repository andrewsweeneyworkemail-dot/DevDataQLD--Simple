diff --git a/scripts/dev_i_pipeline.py b/scripts/dev_i_pipeline.py
new file mode 100644
index 0000000000000000000000000000000000000000..775b2f42bd75d3d8f3f6e65887acab39f121e9f7
--- /dev/null
+++ b/scripts/dev_i_pipeline.py
@@ -0,0 +1,478 @@
+#!/usr/bin/env python3
